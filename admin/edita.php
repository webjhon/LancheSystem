...
<body>
  <div class="container-fluid">
    ...
    <div class="row">
      ...
      $id = $_GET['id'];
      $resultado = "SELECT * FROM funcionarios WHERE funcionarios.id = '$id' ";
      ...
      <div class="col-md-offset-0 col-md-8 col-md-offset-2" id="conteudo_admin">
              <div>
                  <form class="form-horizontal" method="post" action="sql_edit.php?id=<?= $row['id']; ?>">
            <fieldset>
              ...
              <div class="form-group">
                ...
                <div class="col-md-6">
                  <input id="cad_nome" name="cad_nome" type="text" placeholder="Nome" class="form-control input-md" required="" autofocus="" value="<?php echo $row['nome']; ?>">
              ...
              <div class="form-group">
                ...
                <div class="col-md-6">
                  <select id="cad_cargo" name="cad_cargo" class="form-control" required="" autofocus="" value="<?php echo $row['cargo']; ?>" required="">
              ...
              <div class="form-group">
                ...
                <div class="col-md-6">
                  <input id="cad_login" name="cad_login" type="text" placeholder="login" class="form-control input-md" required="" autofocus="" value="<?php echo $row['login']; ?>">
              ...
              <div class="form-group">
                ...
                <div class="col-md-6">
                  <input id="cad_senha" name="cad_senha" type="password" placeholder="Senha" class="form-control input-md" required="" autofocus="" value="<?php echo $row['senha']; ?>">
              ...
              <div class="form-group">
                ...
                <div class="col-md-4">
                  <button id="cad_envia" name="cad_envia" class="btn btn-primary">Editar</button>
                </div>
